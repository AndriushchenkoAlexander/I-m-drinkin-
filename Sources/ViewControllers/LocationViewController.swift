...
//        super.viewDidLoad()
//        print("--==** CURRENT Device ID:  \n\( AppID.shared.loadDeviceID() ?? "ID is absent") **==--")
//        
//        setupInstructions()
//        
//        setupDescription()
...
//        AlertView.sharedInstance.showNotifyView(self, "Добавьте подробностей", "Например: ваше имя, название заведения, локация внутри заведения, описание компании и т.д.", "top") {}
//    }
//    
...
//        markersArray = result
//            .compactMap { Mapper<Booze>().map(JSONObject: $0) }
...
//    }
//    
//    func setupMapMarkerWith(_ boozeUp: Booze) -> GMSMarker {
//        let drink = String(boozeUp.drink ?? Int())
//        
//        let marker = GMSMarker(position: CLLocationCoordinate2D(latitude: AlertView.sharedInstance.stringToDouble(string: boozeUp.latitude), longitude: AlertView.sharedInstance.stringToDouble(string: boozeUp.longitude)))
//        
...
//        
//        if let deviceID =  AppID.shared.loadDeviceID() {
//            dictParameter["device"]      = deviceID
//            dictParameter["drink"]       = drink
//            dictParameter["latitude"]    = AlertView.sharedInstance.stringCoordinates(double: latitude)
//            dictParameter["longitude"]   = AlertView.sharedInstance.stringCoordinates(double: longitude)
...
//            AlertView.sharedInstance.showNotifyView(self, "Warning!", details, "center") {}
...
//            switch(index) {
//            case 0:
//                coachViews.bodyView.hintLabel.text = AlertView.CoachMarkText.checkInButtonText
//                coachViews.bodyView.nextLabel.text = AlertView.CoachMarkText.nextButtonText
//            case 1:
//                coachViews.bodyView.hintLabel.text = AlertView.CoachMarkText.checkInWithDrinksText
//                coachViews.bodyView.nextLabel.text = AlertView.CoachMarkText.nextButtonText
//            case 2:
//                coachViews.bodyView.hintLabel.text = AlertView.CoachMarkText.descriptionViewText
//                coachViews.bodyView.nextLabel.text = AlertView.CoachMarkText.nextButtonText
//            default: break
//            }
//            
...
//        print("!!! LocationViewController \n")
//        setupMapView(coordinates: coordinates)
//    }
//    
//    func setupMapView(coordinates: Coordinates) {
